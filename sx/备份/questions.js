const questions = [
    ...
    {
        "question": "已知集合$A=\\{1, 2\\}$，$B=\\{2, 3, 4\\}$，则$A \\cup B$是（ ）",
        "options": [
            "$\\{2\\}$",
            "$\\{2, 3, 4\\}$",
            "$\\{1, 3, 4\\}$",
        ...
        "answer": 3,
        "explanation": "集合的并集包含所有元素，$A \\cup B = \\{1, 2\\} \\cup \\{2, 3, 4\\} = \\{1, 2, 3, 4\\}$"
    },
    {
        "question": "不等式$3x \\geqslant 8 - x$的解集是（ ）",
        "options": [
            "$(-\\infty, 2)$",
            "$(-2, +\\infty)$",
            "$(2, +\\infty)$",
        ...
        "answer": 3,
        "explanation": "解方程：$3x + x \\geq 8 \\Rightarrow 4x \\geq 8 \\Rightarrow x \\geq 2$，解集为闭区间$[2, +\\infty)$"
    },
    {
